import e from "tailwindcss/defaultTheme";
const a = {
  ...
  theme: {
    ...
    fontFamily: {
      sans: ["Lexend", ...e.fontFamily.sans],
      display: ["Lexend", ...e.fontFamily.sans],
      body: ["Lexend", ...e.fontFamily.sans],
      smallcaps: ["Lexend", ...e.fontFamily.sans]
    },
    fontSize: {
      "body-xs": [
        "0.75rem",
